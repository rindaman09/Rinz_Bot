...
let botname = 'Rinz Bot' //NAMA BOT
let zerokey =  'Alphabot' //BIARIN AE:V
let lolkey = 'KurrXd' // FREE APIKEY NYOLONG DARI KURR:v
let zekskey = 'aYSw7bV2LidKlbCdfvxq233Jrsd' //Ganti Pake Api Lu Sendiri Biar Limitnya Gak Cepet Abis , Login Di zeks.me Untuk Mendapatkan Api Gratis
let ownername = 'Lord Rinz' //NAMA OWNER
let owner = '6285735059141' // NOMOR OWNER
let bold = '*' 
let petik = '```'
let faketeks = `_Rinz Bot By Lord Rinz` 
...
const zer = "6285735059141@s.whatsapp.net"
const kuz = "6285939752324@s.whatsapp.net"
const txt = mek.message.conversation
const botNumber = zeroyt7.user.jid
const ownerNumber = [`${owner}@s.whatsapp.net`, `6285735059141@s.whatsapp.net`]
...
const kon2 = `${faketeks}`
const kon3 = [{buttonId: `!sc`,buttonText: {displayText: `Waipunya Keking? `,},type: 1,},{buttonId: `!sewabot`,buttonText: {displayText: `Pasti Ganteng🗿`,},type: 1,}]
...
const katalog = (teks) => {
res = zeroyt7.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "Rinz😈", "thumbnail": fs.readFileSync('thumbnail.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
zeroyt7.relayWAMessage(res)}
const fakeyt = (teks) => { 
zeroyt7.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `Lord Rinz🗿`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://youtu.be/hiCXprefixlbAHA", "thumbnail": fs.readFileSync('thumbnail.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Follow My Ig @realrinda_", 'jpegThumbnail': fs.readFileSync('thumbnail.jpg')}}}
...
👉❱${p2} ${bold}randommenu${bold}
👉❱${p2} ${bold}downloadmenu${bold}
👉❱${p2} ${bold}animemenu${bold}
👉❱${p2} ${bold}infomenu${bold}
👉❱${p2} ${bold}randomtextmenu${bold}
👉❱${p2} ${bold}randomimagemenu${bold}
👉❱${p2} ${bold}searchmenu${bold}
👉❱${p2} ${bold}kerangmenu${bold}
👉❱${p2} ${bold}gamemenu${bold}
👉❱${p2} ${bold}stalkmenu${bold}
👉❱${p2} ${bold}asupanmenu${bold}
...
👉❱${p2} ${bold}ownermenu${bold}
👉❱${p2} ${bold}othermenu${bold}
...
zeroyt7.sendMessage(from, { contentText: `${ok}`, footerText: `Rinz Bot`, buttons : [{ buttonId: `.botstat`, buttonText: { displayText: 'BOT STATISTIC' }, type: 1 },{ buttonId: `.sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 }], 
...
dtod = `${sender}`
uwu = '```'
tescok = `*Fake Doc By Rinz*`
Sendbutdocument(from, tescok, "RinzP", fs.readFileSync('./F4/KunzX.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('thumbnail.jpg'), filename:`KunzX.pdf`, pageCount: 9999999 }, [{buttonId:`!86`,buttonText:{displayText:'Lord Rinz'},type:1}], {quoted:fstatus, contextInfo: { mentionedJid: [dtod,otod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hi ${pushname}\nDownload Script`,mediaType:"2",thumbnail:fs.readFileSync('thumbnail.jpg'),mediaUrl:`https://youtu.be/dQw4w9WgXcQ`}}})
break
...
costum(buffer, sticker, Verived, `Udah Bang`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Udah Bang`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
case 'asupan':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.result)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupancecan':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/cecan?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupanhijaber':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/hijaber?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupansantuy':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/santuy?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupanukhti':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/ukty?apikey=Alphabot`)
reply(mess.wait) 
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupanbocil':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/bocil?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupanghea':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/ghea?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
case 'asupanrika':
ini = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/rikagusriani?apikey=${zerokey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, video, {quoted: fstatus, caption: 'Nih Asupan >.<'})
break
...
case 'cecanvietnam':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/vietnam?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
case 'cecanmalaysia':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/malaysia?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
case 'cecankorea':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/korea?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
case 'cecanindonesia':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/indonesia?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
case 'cecanjapan':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/japan?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
case 'cecanthailand':
huft = await fetchJson(`https://rinz-api.herokuapp.com/api/cewe/thailand?apikey=${zerokey}`)
reply(mess.wait)
goo = await getBuffer(huft.result.url)
zeroyt7.sendMessage(from, goo, image, {quoted: fstatus, caption: 'Nih Cecan🐣'})
break
...
headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '',
jpegThumbnail: fs.readFileSync("thumbnail.jpg"), 
contextInfo: {mentionedJid: [Verived, + "@s.whatsapp.net"]}}}, 'buttonsMessage')
break
